...
- **Use when**: Sufficient data points (≥3) and non-linear relationships
...
### Linear Interpolation
- ✅ **Use when**: Linear relationship between EM and treatment effect
- ✅ **Use when**: Limited data points (< 5 studies)
- ✅ **Use when**: Need simple, interpretable results
- ❌ **Avoid when**: Clear non-linear relationships exist

### Spline Interpolation  
- ✅ **Use when**: Non-linear relationships expected
- ✅ **Use when**: Sufficient data points (≥ 5 studies)
- ✅ **Use when**: Smooth underlying relationship assumed
- ❌ **Avoid when**: Very noisy data or few observations

### Adaptive Discretization
- ✅ **Use when**: Need to maintain compatibility with binary NMI
- ✅ **Use when**: Interpretability is crucial
- ✅ **Use when**: Continuous modeling fails or is inappropriate
- ❌ **Avoid when**: Information loss is a major concern

## Data Requirements

### Minimum Requirements
- **Linear**: ≥ 2 data points
- **Spline**: ≥ 3 data points (falls back to linear if fewer)
- **Discretization**: ≥ 10 observations for stable binning

### Recommended
- **Linear**: 3-5 data points across EM range
- **Spline**: 5-10 data points for stable estimation
- **Discretization**: ≥ 50 observations for optimal binning
