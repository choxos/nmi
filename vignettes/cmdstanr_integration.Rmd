...
- **⚡ Performance**: 2-3x faster sampling than rstan
- **🔧 Better diagnostics**: Enhanced R̂, ESS, and divergent transition warnings
- **🔄 Parallel processing**: Automatic multi-core chain execution
- **💾 Memory efficiency**: Lower memory usage for large models
- **🛠 Modern toolchain**: Latest Stan features and improvements
...
### Installing NMI with cmdstanr Support
...
if (!is.null(nmi_results$nma_results$BUGSoutput)) {
  ...
  cat("Maximum R̂:", round(max_rhat, 3), "\n")
